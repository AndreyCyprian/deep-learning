...
def test_logging(logger: tb.SummaryWriter):
    ...
    for epoch in range(10):
        ...
        for iteration in range(20):
            ...
            # Save train accuracies to be averaged later
            metrics["train_acc"].append(dummy_train_accuracy.mean().item())

            global_step += 1

        # Log average train_accuracy at each epoch
        ...
        for _ in range(10):
            ...
            # Save val accuracies to be averaged later
            metrics["val_acc"].append(dummy_validation_accuracy.mean().item())

        # Log average val_accuracy at each epoch
